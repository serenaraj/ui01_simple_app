		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Simple UI5 Application",
									"targetURL": "#comrizingui5ui01simpleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrizingui5ui01simpleapp-display": {
								"semanticObject": "comrizingui5ui01simpleapp",
								"action": "display",
								"description": "Simple UI5 Application",
								"title": "Simple UI5 Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rizing.ui5.ui01simpleapp",
									"url": sap.ui.require.toUrl("com/rizing/ui5/ui01simpleapp")
								}
							}
						}
					}
